...
* DAI = au moins 5.0h
* Max. Pic peak = 75 minutes after injection (fixed, not adjustable)

#### Insuline Ultra Rapide Oref
* recommendé pour FIASP
* DAI = au moins 5.0h
* Max. Pic peak = 55 minutes after injection (fixed, not adjustable)

#### Lyumjev
* profil d'insuline spécifique pour Lyumjev
* DAI = au moins 5.0h
* Max. Pic peak = 45 minutes after injection (fixed, not adjustable)
