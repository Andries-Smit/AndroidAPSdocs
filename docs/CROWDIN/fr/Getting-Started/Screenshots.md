...
* Works for CGM with additional transmitter such as MiaoMiao 2. Fonctionne pour les MGC qui ont des émetteurs supplémentaires tels que MiaoMiao (Technically sensor has to send cat level information to xDrip+.)
