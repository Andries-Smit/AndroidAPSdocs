...
**Dit artikel is geschreven voordat AndroidAPS versie 2.5 uitkwam. Er is vanaf AAPS versie 2.5 een functie voor [automatisering in AndroidAPS](./Automation.rst) zelf ingebouwd. For some, this here might be still useful, but should only be used by advanced users.**
