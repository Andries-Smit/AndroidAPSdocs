...
* Sport is niet langer beschikbaar, maar je kunt het notitie-veld gebruiken dat naar voren komt wanneer je een actie invoert, bijv. (zie screenshot in sectie `Koolhydraten & bolus <#carbs-- bolus>`_ op deze pagina).
...
* Alle andere functies uit deze sectie zijn verwijderd. Je kunt het notitie-veld gebruiken dat naar voren komt wanneer je een actie invoert, bijv. (zie screenshot in sectie `Koolhydraten & bolus <#id1>`_ op deze pagina).
